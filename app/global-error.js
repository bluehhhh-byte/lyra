    ...
    <html lang="ko">
      <body className="font-sans min-h-screen bg-bg text-ink">
        <main className="mx-auto flex min-h-screen max-w-xl items-center px-5 py-16">
          <section className="w-full rounded-2xl border border-line bg-surface p-6 text-center sm:p-8">
            ...
            <div className="mt-6 flex justify-center gap-3">
              <button type="button" onClick={reset} className="rounded-xl bg-accent px-4 py-2.5 text-sm font-semibold text-bg">다시 시도</button>
              <a href="/" className="rounded-xl border border-line px-4 py-2.5 text-sm font-semibold">홈으로</a>
            </div>
          </section>
        </main>
      </body>
