...
source_note: 
source_hash: 5b28de2550c3c1b963aa9bffe948be1e1d9e264f
lyrics_external: true
lyrics_source: https://lrclib.net/api/get?artist_name=OneRepublic&track_name=I%20Ain't%20Worried
---
I don't know what you've been told
> 네가 무슨 말을 들었는지는 몰라
But time is running out, no need to take it slow
> 하지만 시간은 끝나가고 있어, 천천히 갈 이유가 없지
...
> 훔치고 싶은 게 있을 때 난 가장 잘해
Way too busy for them problems and problems to feel (yeah-yeah)
> 문제들을 느낄 새도 없이 너무 바빠 (예-예)
No stressing, just obsessin' with sealin' the deal
> 스트레스는 없어, 그저 일을 끝내는 데 집착할 뿐
