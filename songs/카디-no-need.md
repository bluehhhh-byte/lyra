...
> (You've always got to be patient)
때를 기다려 머지 않은
> Wait for the moment — it's not far off
곧 다가올 그 때를 기다려
...
> (I won't stop)
애써봐 절대 못 막아
> Go ahead and try — you'll never stop it
아무리 애써도 절대 막을 수 없어
...
> (The end is close)
덧난 결말의 시작을 보러
> To see the start of an ending festered open
상처난 결말의 시작을 보러
> To see the start of a wounded ending
기다린 내
> I who waited —
기다려온 나
> The me who's been waiting
또 다른 내일
> Another tomorrow
위대한 서막이 모두의 눈앞에
...
> Whoever you are, no way to stop this dozer
...
> Betting everything, just right here
(여기서 모든 걸 걸어)
> (I stake it all right here)
...
> (Face it)
겁날 것 없지 걍 Face it
> Nothing to be scared of — just face it
(두려울 것 없어, 그냥 맞서)
> (Nothing to fear, just face it)
베일을 벗긴 그 순간부터
...
더 울려퍼지게
> Let it ring out further
더 크게 울려 퍼지게
> Let it ring out even louder
So I run 벽 넘어
> So I run, over the wall
(그래서 난 벽을 넘어 달려가)
> (So I run past the wall)
All I see 저 너머
> All I see — far beyond
(내가 보는 건 저 너머야)
...
> Even I can't handle it — watch out, myself
(나조차 감당이 안 돼, 나 자신도 조심해야 해)
> (Even I can't handle it — I've got to watch out for myself)
