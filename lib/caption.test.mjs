...
import { buildCaption, buildMovieCaption, buildMovieCarouselCaption } from "./caption.js";
...
assert.equal(
  ...
  "| SUEDE - Trash (1998) #SUEDE #가사 #260714_1531"
);
...
assert.equal(
  ...
  "| 뉴진스 - Supernatural #뉴진스 #가사 #260714_1531"
);
...
assert.equal(
  buildMovieCarouselCaption({ headline: "★5를 준 40편" }, now),
  "| ★5를 준 40편 #Cyno #영화로그 #260714_1531"
);

// 캐러셀도 같은 한 줄 캡션을 쓴다 — 장 수와 무관하게 글은 하나다.
