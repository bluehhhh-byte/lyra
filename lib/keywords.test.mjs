...
import { EMOTIONS, parseEmotion, parseKeywords, emotionValence, valenceColor, tagSuggestions, VALENCE_RANGE } from "./keywords.js";
...
assert.deepEqual(tagSuggestions([{ tags: ["록", "한국"] }, { tags: ["록", "재즈"] }]), ["록", "재즈", "한국"]);
assert.deepEqual(tagSuggestions([{ tags: ["록", "록 발라드", "재즈"] }], "록"), ["록", "록 발라드"]);
console.log("✓ build-time tag suggestions are unique and deterministic");
