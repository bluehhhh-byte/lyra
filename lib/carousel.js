...
// 영화 카드도 같은 자리에서 같은 두 가지를 청한다. 문구만 다르다 —
// 넘길 것이 가사가 아니라 한 편의 기록이다.
export const MOVIE_CTA_PRIMARY = "전체 감상과 기록은 프로필 링크";
export const MOVIE_CTA_SECONDARY = "이 영화가 궁금하면 저장해 두세요";
