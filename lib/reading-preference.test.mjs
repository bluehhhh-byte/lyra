...
import { hasReadings, savedReadingSize, savedReadingVisibility } from "./reading-preference.js";
...
assert.equal(savedReadingSize("l"), "l");
assert.equal(savedReadingSize("huge"), "m", "알 수 없는 크기는 읽기 좋은 기본값으로 복구한다");
