...
import { needsKo, needsEn, needsReadingLine, isNoteLine, songNeeds, translationStatus } from "./admin/needs.js";
...
// 한국 곡에도 영어로만 된 줄이 있고, 거기엔 한국어 번역이 붙어야 한다.
{
  ...
  assert.equal(needsKo(mixed.lines[0], "ko"), true, "한영 혼합 줄 — 영어 뜻이 남아 있으면 번역 필요");
...
// 영어곡에 한국어 한 줄이 섞인 정도까지 세면 대기열이 의미를 잃는다.
{
  ...
  assert.equal(songNeeds(song(body, { lang: "en" })).enTranslation, 0, "외국곡은 대상이 아니다");
