...
assert.deepEqual(parseHeader("| Radiohead - Creep (크리프, 1992)"), {
  artist: "Radiohead", title: "Creep", title_ko: "크리프", year: "1992", summary: "",
});
// 헤더 뒤에 큰따옴표로 한 줄 요약을 붙인 글 — 요약이 제목에 섞이면 안 된다
assert.deepEqual(parseHeader('| MGMT - Piece of What (2006) “사랑조차 지나가버린 자리”'), {
  artist: "MGMT", title: "Piece of What", title_ko: "", year: "2006",
  summary: "사랑조차 지나가버린 자리",
});
