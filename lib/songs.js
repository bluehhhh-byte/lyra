...
const SECTION_WORD = /^(verse|chorus|pre-?chorus|post-?chorus|bridge|intro|outro|hook|refrain|interlude|drop|solo|breakdown|후렴|벌스|브릿지|인트로|아웃트로|간주|훅)\b/i;
export function isSectionLabel(inner) {
  ...
  return t.split(/\s+/).length <= 3;                         // "Rumi", "Jinu", "Verse 1" 같은 것
}
