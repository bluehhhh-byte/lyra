...
import { databaseContentEnabled, listCachedContentRows, noteContentFallback } from "./content-db.js";
...
export async function getSongRuntime(slug) {
  return (await getAllSongsRuntime()).find((song) => song.slug === slug) || null;
}
