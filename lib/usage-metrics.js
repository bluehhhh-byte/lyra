...
export async function getUsageDashboard() {
  ...
  const [rows, pathRows, database, content, neonProvider] = await Promise.all([
  ...
  const status = usageStatus([
    usagePercent(neonTransferBytes, USAGE_LIMITS.neonTransferBytes),
    usagePercent(databaseBytes, USAGE_LIMITS.neonStorageBytes),
  ]);
