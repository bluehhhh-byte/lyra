...
// collections share the same read/write/delete logic.
...
const collections = makeStore("collections");
...
export const readCollection = collections.read;
export const writeCollection = collections.write;
export const deleteCollection = collections.remove;

// Plain-file store for the watched dataset (data/*.json) — same read-only-FS →
// GitHub-commit rule as the .md stores, but no frontmatter, no slug dir.
