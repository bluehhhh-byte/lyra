...
export function buildSingleMovieCarousel(input, overrides = {}) {
  ...
  return {
    ...
    slides: [
      ...
      { role: "basic", label: "기본 설명", movie, text: clean(draft.basicDescription) },
      { role: "synopsis", label: "줄거리", movie, text: clean(draft.synopsis) },
      { role: "key-points", label: "주요 내용", movie, points: keyPoints.slice(0, 3) },
