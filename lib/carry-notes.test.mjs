...
// each note must land under the line that opened its old stanza
const lines = r.body.split("\n");
assert.equal(lines[lines.indexOf("That there") + 1], "// 화자가 자신을 3인칭으로 밀어낸다", "verse note anchored");
assert.equal(lines[lines.indexOf("I'm not here") + 1], "// 후렴의 해리감", "chorus note anchored");
