...
assert.match(adminHome, /import Link from "next\/link"/, "Lyra 관리자 내비게이션은 Next.js Link를 가져와야 한다");
...
const rules = [
  [/const W = CAROUSEL_THEME\.width/, "공통 Instagram 원본 너비가 필요하다"],
  [/const H = CAROUSEL_THEME\.height/, "공통 Instagram 원본 높이가 필요하다"],
