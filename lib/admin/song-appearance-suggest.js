...
function normalizeAppearance(parsed, sources, songIdentity) {
  ...
  return {
    ...
    appearance: {
      ...
      // 리서치가 근거 페이지에서 확인한 감독 이름. 한글 표기는 검수자가 채운다.
      director: cleanLine(parsed.director, 200),
      workType,
...
설명 없이 JSON 한 개만 출력:
{"comment":"...","commentBasis":"lyrics_only|web_enriched","commentEvidenceUrls":["https://..."],"appearance":{"found":true|false,"conflict":false,"workTitle":"","originalTitle":"","director":"","workType":"movie","role":"insert_song","year":2022,"season":null,"episode":null,"note":"","evidenceClaim":"곡과 작품의 직접 관계","evidenceUrl":"https://..."}}`
  );
