...
assert.equal(archive[0].insight.day, "2026-07-28");
assert.match(archive[0].insight.text, /Dream Pop의 질감/);
assert.match(archive[0].insight.text, /가족·기억의 영화도 같은 여운/);
assert.doesNotMatch(archive[0].insight.text, /음악 1곡|영화 1편|표본|밝기|각성/);
